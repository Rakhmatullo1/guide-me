package uz.guideme.fileservice.configuration;

import jakarta.annotation.PostConstruct;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;
import uz.guideme.fileservice.configuration.properties.StorageProperties;
import uz.guideme.fileservice.enumeration.MimeType;
...
public class StorageConfiguration {
    ...
    private Map<String, String> initializeSupportedMimeTypes() {
        ...
        Arrays.stream(MimeType.values())
                .forEach(mimeType -> map.put(mimeType.getType().toString(), mimeType.getExtension()));
